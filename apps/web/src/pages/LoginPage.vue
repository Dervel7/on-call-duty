...
<template>
  <div class="relative grid min-h-screen place-items-center overflow-hidden px-6 py-12">
    ...
    <svg
      class="pointer-events-none absolute inset-x-0 bottom-0 -z-10 h-40 w-full text-primary/20"
    ...
    >
      <path
        d="M0 90 H320 l28-58 l34 116 l30-150 l36 92 H760 l26-46 l32 80 H1200"
        class="ekg-line"
        stroke="currentColor"
        stroke-width="3"
